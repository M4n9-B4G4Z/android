...
limitawal = 30
memberlimit = 30
cr = '*BOT NYA BAGAZ GANS NIH BOSS*'
/*************************************/

/******** OWNER NUMBER**********/
const ownerNumber = ["6282131282262@s.whatsapp.net","6281938781378@s.whatsapp.net"] 
/************************************/
...
const client = new WAConnection()
   ...
   console.log(color('[','white'),color('∆','red'),color(']','white'),color('QR Already Scan. Follow','white'),color('INSTA','red'),color('GRAM','white'),color('@bagazzzsss','yellow'))
})
